  ...
  return (
    <div className="container py-5 sm:py-10">
      ...
      <div className="relative h-36 md:h-60 w-[calc(100%-20px)]">
        ...
        <div className="">
          <button
            className="z-20 absolute top-12 sm:top-20 -left-6 w-12 h-12 text-4xl font-light bg-orange-450 text-white rounded-full"
            onClick={() => swiperRef.current.slidePrev()}>
            <i className="bx bx-left-arrow-alt"></i>
          </button>
          <button
            className="z-20 absolute top-12 sm:top-20 -right-6 w-12 h-12 text-4xl font-light bg-orange-450 text-white rounded-full"
